...
public class Test07ListarMercaderiaPorCodigoCrecienteProfe {
    ...
    void listadoIngresoOrdenado() {
        ...
        retorno = s.listarMercaderiasPorCodigoAscendente();
        assertEquals(Retorno.Resultado.OK, retorno.getResultado());
        assertEquals("COD02;XX-001-XXX121;Descripción 2;false;Otros|COD03;XX-001-XXX122;Descripción 3;false;Otros|COD01;XX-001-XXX123;Descripción 1;false;Otros", retorno.getValorString());
    }
